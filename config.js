module.exports = function(express, app, mongoose, cookie, models, redisClient) {
	...
	app.use(function(req, res, next){
		...
		res.cookie('uuid', 'nNEYxOEU4NjctMjQzOS00NzMzLUI0QzgtQjE4N0QxNEQzNDU3', { maxAge: 100*60*1000, httpOnly: false });
		...
		req.headers['x-userid'] = 'nNEYxOEU4NjctMjQzOS00NzMzLUI0QzgtQjE4N0QxNEQzNDU3';
		// return next();
