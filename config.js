module.exports = function(express, app, mongoose, cookie, models, redisClient) {
	...
	app.use(function(req, res, next){
		...
		// res.cookie('uuid', 'iNEYxOEU4NjctMjQzOS00NzMzLUI0QzgtQjE4N0QxNEQzNDUosih3', { maxAge: 100*60*1000, httpOnly: false });
		...
		// req.headers['x-userid'] = 'iNEYxOEU4NjctMjQzOS00NzMzLUI0QzgtQjE4N0QxNEQzNDUosih3';
